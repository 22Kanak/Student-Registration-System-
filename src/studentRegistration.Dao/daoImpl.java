...
public class daoImpl implements dao {
	...
	public boolean studentDetailEdit(String sEmail, String sPassword, String sNewPassword, String sNewName,
			String sNewCourseName ) throws SQLException, CourseException {
		// TODO Auto-generated method stub
		boolean answer = false;
		dao daoObj = new daoImpl();
		BatchRecord br = null;
...
//		display with batch aggregation
	...
	public boolean checkForAdmin() {
	    ...
	    String adminUsername = "sachin";
	    String adminPassword = "sachin123";
	    ...
	    boolean isAuthenticated = adminUsername.equals(enteredUsername) && adminPassword.equals(enteredPassword);
